...
function Lobby() {
    ...
    const handleSearchChange = (e) => {
        ...
        setRoomNumber(rooms.filter(room => room.id.indexOf(e.target.value) !== -1 || room.data.roomName.indexOf(e.target.value) !== -1).length)
        if (e.target.value === '') {
    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.room}>
                <Grid container >
                    {rooms.map(({id, data: { roomName, roomScale } }) => Children.toArray(
